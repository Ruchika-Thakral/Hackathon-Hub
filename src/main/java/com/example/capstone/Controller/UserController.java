...
public class UserController {
	...
	public ResponseEntity<MessageResponse> generateOtp(@RequestBody UserDTO userDto) {
	...
	public ResponseEntity<MessageResponse> validateOtp(@RequestBody EmailVerificationDTO emailVerificationDto) {
