...
public interface JudgeRepository extends JpaRepository<Judge, Integer> {
	 @Query("SELECT NEW com.example.capstone.DTO.TeamDetailsToJudgeDTO(t.teamId, t.ideaRepo, t.ideaFiles,t.ideaBody,t.ideaDomain,t.name,t.status) FROM Team t WHERE t.hackathon.hackathonId = :hackathonId AND t.status = com.example.capstone.Entity.Status.selected")
