    ...
    const arr = [
        {
            ...
            teams: [
                ...
                },
                {
                    ...
                    description:
                        "vitae tortor condimentum lacinia quis vel eros donec ac odio tempor orci dapibus ultrices in iaculis nunc sed augue lacus viverra vitae congue eu consequat ac felis donec et odio pellentesque diam volutpat commodo sed egestas egestas fringilla phasellus faucibus scelerisque eleifend donec pretium vulputate sapien nec sagittis aliquam malesuada bibendum arcu vitae elementum curabitur vitae nunc sed velit dignissim sodales ut eu sem integer vitae justo eget magna fermentum iaculis eu non diam phasellus vestibulum lorem sed risus ultricies tristique nulla aliquet enim tortor at auctor urna nunc id cursus metus aliquam eleifend mi in nulla posuere sollicitudin aliquam ultrices sagittis orci a scelerisque purus semper eget duis at tellus at urna condimentum mattis pellentesque id nibh tortor id aliquet lectus proin nibh nisl condimentum id venenatis a condimentum vitae sapien pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas sed tempus urna et pharetra pharetra massa massa ultricies mi quis hendrerit dolor magna eget est lorem ipsum dolor sit amet consectetur adipiscing elit pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas integer eget aliquet nibh praesent tristique magna sit amet purus gravida quis blandit turpis cursus in hac habitasse",
                    video: "https://youtube.com/teamY",
                    googleDrive: "https://drive.google.com/teamY",
                },
                {
                    name: "Team C",
                    idea: "Idea 3",
                    ...
                    googleDrive: "https://drive.google.com/teamZ",
                },
                {
                    name: "Team D",
                    idea: "Idea 4",
            ...
            teams: [
                {
                    ...
                    idea: "Idea X",
                    image: "https://picsum.photos/900/350",
                    description: "Description for Team X",
                    googleDrive: "https://drive.google.com/teamZ",
                },
                {
                    name: "Team Y",
                    idea: "Idea Y",
                    image: "https://picsum.photos/900/350",
                    description: "Description for Team Y",
                    googleDrive: "https://drive.google.com/teamZ",
                },
                {
                    name: "Team Z",
                    idea: "Idea Z",
                    image: "https://picsum.photos/900/350",
                    description: "Description for Team Z",
                    googleDrive: "https://drive.google.com/teamZ",
                },
            ],
        },
            ...
            teams: [
                {
                    ...
                    description: "Description for Team P",
                    googleDrive: "https://drive.google.com/teamZ",
                },
                {
                    name: "Team Q",
                    idea: "Idea Q",
                    image: "https://picsum.photos/900/350",
                    description: "Description for Team Q",
                    googleDrive: "https://drive.google.com/teamZ",
                },
                {
                    name: "Team R",
                    idea: "Idea R",
                    image: "https://picsum.photos/900/350",
                    description: "Description for Team R",
                    googleDrive: "https://drive.google.com/teamZ",
                },
            ],
        },
            ...
            teams: [
                {
                    ...
                    idea: "Idea M",
                    image: "https://picsum.photos/900/350",
                    description: "Description for Team M",
                    googleDrive: "https://drive.google.com/teamZ",
                },
                {
                    name: "Team N",
                    idea: "Idea N",
                    image: "https://picsum.photos/900/350",
                    description: "Description for Team N",
                    googleDrive: "https://drive.google.com/teamZ",
                },
                {
                    name: "Team O",
                    idea: "Idea O",
                    image: "https://picsum.photos/900/350",
                    description: "Description for Team O",
                    googleDrive: "https://drive.google.com/teamZ",
                },
            ],
        },
