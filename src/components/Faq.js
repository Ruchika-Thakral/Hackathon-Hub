...
const Faq =()=> {
  ...
  return (
    <>
    <Typography variant="h2" color="blue-gray" className="mb-2 font-medium flex justify-center mt-2">
                    FAQ
                </Typography>
      <Accordion open={open === 1} className="mb-2 rounded-lg border border-blue-gray-100 px-4">
        ...
        <AccordionBody className="pt-0 text-base font-normal">
          You can form a team of four members, then you have to register the team in the registration
          form along with your team name and idea for the hackathon.
        </AccordionBody>
      </Accordion>
