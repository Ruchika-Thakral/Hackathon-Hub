...
function Home() {
  ...
  const dummyUser = {
    ...
    <SignUpDialog showModal={showSignUpModal} toggleModal={toggleSignUpModal} />
    <SignInDialog showModal={showSignInModal} toggleModal={toggleSignInModal} toggleModals={toggleSignUpModal}/>
